class WarmwindOS {
    constructor(apps = [], controls = {}) {
        ...
        this.features = [
            ...
            // --- [REPLACE WITH THIS NEW OBJECT] ---
{
    name: 'VibeOS Scholar',
    description: "Get step-by-step help for your homework.",
    action: 'launchScholar',
    layout: 'module-scholar',
    videoSrc: 'assets/videos/scholar-bg.mov' // Make sure you have a video at this path
},
            {
                name: "Focus Timer",
